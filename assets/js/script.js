...
$(".searchBtn").on("click", function(event) {
    ...
    for (let i = 0; i < searchedCities.length; i++) {
        ...
        if (!searched){
            ...
            var btn = document.createElement("button")
            btn.setAttribute('class', "btn btn-secondary m-3")
    ...
    .then((data) => {
        ...
        $("#icon0").attr("src", "https://openweathermap.org/img/wn/" + data.weather[0].icon + "@2x.png" )
    ...
    .then((data2) => {
      ...
      $("#icon2").attr("src", "https://openweathermap.org/img/wn/" + data2.list[15].weather[0].icon + "@2x.png" )  
      ...
      $("#icon3").attr("src", "https://openweathermap.org/img/wn/" + data2.list[23].weather[0].icon + "@2x.png" )  
      ...
      $("#icon4").attr("src", "https://openweathermap.org/img/wn/" + data2.list[31].weather[0].icon + "@2x.png" )  
      ...
      $("#icon5").attr("src", "https://openweathermap.org/img/wn/" + data2.list[39].weather[0].icon + "@2x.png" )  
